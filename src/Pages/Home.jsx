    ...
    return (
      ...
      <Container className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-6">
          <Link to="/signup">
            <Button size="lg" className="px-6 py-4 border-2 bg-blue-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center">
              Get Started
          ...
          <Link to="/login">
            <Button
              variant="outline"
              size="lg"
              className="px-6 py-4 border-2 text-gray-800 "
            >
              Sign In
            </Button>
          </Link>
...
<section className="py-16 px-6">
  <Container className="max-w-5xl mx-auto">
    <div className="flex flex-col md:flex-row justify-between gap-12">
      {/* Rich Editor */}
      <div className="flex-1  bg-white rounded-xl shadow hover:shadow-md transition text-center">
      ...
      {/* Community */}
      <div className="flex-1 p-6 bg-white rounded-xl shadow hover:shadow-md transition text-center">
